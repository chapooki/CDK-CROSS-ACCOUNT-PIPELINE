...
// import { FoundationsStack } from "../lib/foundations/foundations-stack";
import { Constants } from "../config/AppConstants";

const app = new cdk.App();

// new FoundationsStack(app, `FoundationsStack-${Constants.devProps.env}`, {
...
// new FoundationsStack(app, `FoundationsStack-${Constants.uatProps.env}`, {
